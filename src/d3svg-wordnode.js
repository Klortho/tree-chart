...
(function() {
  ...
  class D3svg_WordNode {
    constructor(d3svg) {
      ...
      d3svg.defs.append('defs').html(D3svg_WordNode.dropShadowFilter);
    }
    ...
    getTextMetrics(word) {
      ...
      const textElem = this.d3svg.frame.append("text")
        ...
        .style({
          opacity: 0,
          'font-size': opts.chart['font-size'] + 'pt',
  ...
  // Drop-shadow
  D3svg_WordNode.dropShadowFilter = 
  ...
  TreeChart.D3svg_WordNode = D3svg_WordNode;
})();
